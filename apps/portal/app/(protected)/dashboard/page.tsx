...
export default async function DashboardPage({ searchParams }:{ searchParams:Promise<{ mission?:string }> }) {
  ...
  return <div className="app-shell"><Sidebar/><main className="main-content vault-page"><header className="page-heading dashboard-heading"><span>APOLLO MISSION CONTROL · ONLINE</span><h1>Command overview</h1><p>Launch the next move, see mission health, and enter the right operating environment when you need granular control.</p></header><MissionLedger view="dashboard"/></main></div>
}
