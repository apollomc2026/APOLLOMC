...
export interface DeliverableSpecification {
  ...
  aura: { authority: number; warmth: number; technicality: number; restraint: number; urgency: number; prestige: number; visual_density: number; operator_involvement?: number; keywords: string[]; avoid: string[] }
